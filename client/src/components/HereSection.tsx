...
const HereSection = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row max-w-6xl mx-auto md:p-10 rounded-lg items-center justify-center m-4 gap-20">
  ...
  <img
    src={HereImage}
    alt=""
    className="object-cover w-full max-h-[500px] animate-rotate360"
  />
</div>
